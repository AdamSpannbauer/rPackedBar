...
#                                                       .Names = c("type", "fillcolor", "line", "x0", "x1", "xref", "y0", "y1", "yref"))),
#                             ann_list = list(structure(list(x = 0.001, y = 0.833333333333333,
#                                                            xref = "x", yref = "y",
#                                                            text = "w", showarrow = FALSE, xanchor="left", font=list(color="black")),
#                                                       .Names = c("x", "y", "xref", "yref", "text", "showarrow", "font")),
#                                             structure(list(x = 0.001, y = 0.5,
#                                                            xref = "x", yref = "y",
#                                                            text = "u", showarrow = FALSE, xanchor="left", font=list(color="black")),
#                                                       .Names = c("x", "y", "xref", "yref", "text", "showarrow", "font")),
#                                             structure(list(x = 0.001, y = 0.166666666666667,
#                                                            xref = "x", yref = "y",
#                                                            text = "l", showarrow = FALSE, xanchor="left", font=list(color="black")),
#                                                       .Names = c("x", "y", "xref", "yref", "text", "showarrow", "font"))),
